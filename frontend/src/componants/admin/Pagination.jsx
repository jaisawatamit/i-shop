    ...
    for (let i = 1; i <= totalpage; i++) {
        pageListing.push(<li>
            <span key={i}
                ...
                className={`${current_page == i && "bg-red-600"} flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white cursor-pointer`}
            >
                {i}
            </span>
        </li>)
